  ...
  return (
    <ContextMenu>
      ...
      <ContextMenuContent className="w-52 p-1 rounded-lg" style={{ background: colors.bg.float, border: `1px solid ${colors.border.strong}`, boxShadow: '0 8px 32px rgba(0,0,0,0.6)' }}>
        ...
        {!isDeleted && onForward && <ContextMenuItem onClick={() => onForward(message)} className="text-[13px] gap-2 rounded-md px-2 py-1.5" style={{ color: colors.text.secondary }}><ArrowRight className="w-4 h-4 opacity-50" /> Forward</ContextMenuItem>}
