...
const MessageBubble = memo(function MessageBubble({ message, compact, isOwn, onReply, onEdit, onDelete, onReact, onPin, onStar, onForward, currentUserId, onProfileClick, isEditing, roleColor,
