    ...
    <div className="space-y-6">
          ...
          {PERMISSIONS.map(p => (
            <button key={p.id} onClick={() => togglePerm(p.id)}
              ...
              <div className="w-4 h-4 rounded-md flex items-center justify-center flex-shrink-0 mt-0.5"
                ...
                {permissions.includes(p.id) && <span className="text-white text-[10px]">✓</span>}
              </div>
              <div>
      ...
      <div className="rounded-2xl p-5" style={{ background: 'var(--bg-glass)', border: '1px solid var(--border)' }}>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="text-[9px] font-semibold uppercase tracking-[0.08em] block mb-1" style={{ color: 'var(--text-muted)', fontFamily: 'monospace' }}>Messages / Minute</label>
          ...
          <div>
            <label className="text-[9px] font-semibold uppercase tracking-[0.08em] block mb-1" style={{ color: 'var(--text-muted)', fontFamily: 'monospace' }}>Commands / Minute</label>
        ...
        <p className="text-[10px] mt-2" style={{ color: 'var(--text-faint)' }}>Set to 0 for unlimited. Recommended: 30 messages, 10 commands per minute.</p>
      </div>
