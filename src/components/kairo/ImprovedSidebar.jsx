      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <motion.button
            ...
            className="w-10 h-10 rounded-xl bg-white/5 hover:bg-white/10 text-zinc-500 hover:text-white flex items-center justify-center transition-colors relative"
          >
...
export default function ImprovedSidebar({ 
  ...
  return (
    ...
    >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <motion.button
                ...
                className="w-6 h-6 rounded-md bg-white/5 hover:bg-white/10 text-zinc-500 hover:text-white flex items-center justify-center transition-colors"
              >
                <motion.div
      ...
      {/* Servers - Icon list with smooth animations */}
      <div className="flex-1 overflow-y-auto scrollbar-none py-2 flex flex-col items-center gap-2">
        ...
        {/* Server icons with staggered animations */}
                ...
                <motion.button
                  ...
                  className={cn(
                    ...
                    activeServerId === server.id 
                      ? "ring-2 ring-emerald-500 ring-offset-2 ring-offset-[#0d0d0f] kairo-sync" 
                ...
                >
                  ...
                  {server.unread > 0 && (
                    <motion.div 
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
                      className="absolute -bottom-0.5 -right-0.5 w-4 h-4 bg-red-500 rounded-full text-[9px] font-bold text-white flex items-center justify-center"
                    >
        ...
        <TooltipProvider delayDuration={100}>
          <Tooltip>
            <TooltipTrigger asChild>
              <motion.button
                whileHover={{ scale: 1.08, backgroundColor: 'rgb(16, 185, 129)' }}
                whileTap={{ scale: 0.95 }}
                onClick={onCreateServer}
                className="w-10 h-10 rounded-xl bg-white/5 text-zinc-500 hover:text-white flex items-center justify-center transition-colors"
              >
