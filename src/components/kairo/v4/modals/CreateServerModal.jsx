...
import { 
  Plus, Upload, Users, Gamepad2, Code, Lock, 
  Video, Calendar, ArrowRight, ArrowLeft, Check, X
} from 'lucide-react';
    ...
    >
      <AnimatePresence mode="wait">
        {step === 1 ? (
          ...
          >
            <h2 className="text-xl font-semibold text-white mb-2">Create Your Server</h2>
          ...
          >
            ...
            <h2 className="text-xl font-semibold text-white mb-2">Customize Your Server</h2>
            <p className="text-sm text-zinc-500 mb-6">
            ...
            <div className="flex justify-center mb-6">
              <label className="relative cursor-pointer group">
                <div className={cn(
                  ...
                  'bg-white/[0.06] border-2 border-dashed border-white/[0.12]',
                  'group-hover:border-indigo-500/50 transition-colors overflow-hidden'
                )}>
                  {iconPreview ? (
